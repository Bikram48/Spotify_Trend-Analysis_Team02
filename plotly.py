...
data_df = pd.read_csv("/Users/bikram/Downloads/tracks.csv")

app = dash.Dash(__name__)

# Dropdown options for artists
    ...
    children=[
        ...
        html.Div(
            ...
            children=[
                ...
                # New section for artist selection and song display
                html.Div(
...
def update_song_chart(selected_artist):
    ...
    # Create horizontal bar chart for song popularity
    data = [
        go.Bar(
